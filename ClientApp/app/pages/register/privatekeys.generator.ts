...
export class PrivateKeysGenerator {
  static generate(exportResponse?: any, username?: any, recoveryKey?: any) {
    ...
    const addDetails = (
      ...
      const SmartCard = {
        localization: {
          pdf: {
            ...
            recoveryKeyNotPuted:
              "We were unable to identify your Master Security Code",
            name: "USERNAME",
      ...
      if (recoveryKey) {
        doc.setFontStyle("bold");
        const encryptedKeySplit = doc.splitTextToSize(recoveryKey, 400);
    ...
    if (exportResponse) {
      ...
      addDetails(document, null, username, recoveryKey);
    }

    const obj = {
      filename: `privateKeys_${username}.pdf`,
